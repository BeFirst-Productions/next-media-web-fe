          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-10'>
            ...
            <div className='lg:col-span-1 md:ps-2 ps-4 lg:ps-0'>
              ...
              <ul className='space-y-3'>
                ...
                <li>
                  <Link href='/aboutus' className='text-gray-300 hover:text-transparent hover:bg-clip-text hover:bg-gradient-to-b hover:from-[#F53A7A] hover:to-[#190CD2] transition-all duration-300 text-base font-normal'>
                    About Us
                  </Link>
                </li>
                <li>
                  <Link href='/services' className='text-gray-300 hover:text-transparent hover:bg-clip-text hover:bg-gradient-to-b hover:from-[#F53A7A] hover:to-[#190CD2] transition-all duration-300 text-base font-normal'>
                    Services
                  </Link>
                </li>
                <li>
                  <Link href='/projects' className='text-gray-300 hover:text-transparent hover:bg-clip-text hover:bg-gradient-to-b hover:from-[#F53A7A] hover:to-[#190CD2] transition-all duration-300 text-base font-normal'>
                    Projects
                  </Link>
                </li>
              </ul>
