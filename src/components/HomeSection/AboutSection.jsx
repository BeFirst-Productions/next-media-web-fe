...
const AboutSection = () => {
  ...
  const CustomColor = ({ children }) => (
    <span style={{ color: '#29ABE2' }}>{children}</span>
  );
  ...
  return (
    ...
    >
      ...
      <div className="relative   max-w-7xl mx-auto flex flex-col pt-24">
        <motion.div
          ...
          <motion.div variants={fadeInVariants}>
            <div className="space-y-8 text-lg  xl:pr- xl:pl-0 lg:pt-16 ">
              ...
              >
                ...
                businesses unlock their full potential. We believe that with the
                right strategy and creativity, every brand can make a
                significant impact in its industry. Our goal is to empower
                businesses with innovative marketing solutions that drive
                results and create lasting impressions. Join us on this journey
                to redefine success.
              </motion.p>
              {/* <motion.p 
                variants={fadeInVariants} 
          ...
          >
            ...
            <div className="space-y-6 text-base 2xl:text-lg">
              <p>
                ...
                dynamic digital solutions agency that specializes in delivering
                innovative branding, stunning design, and impactful digital
                marketing.
              </p>
              <p>
                Founded with a vision to empower brands in the digital age, Next
                Digital blends creativity with technology to craft experiences
                that connect, engage, and inspire.
              </p>
              <p>
                Whether you're a startup ready to make your mark or an
                established business seeking to evolve, we are your creative
          ...
          >
            ...
            <div>
              ...
              <p className=" text-base md:text-lg leading-relaxed">
                To become a leading global marketing agency recognized for
                transforming brands through creativity, strategy, and
                technology.
              </p>
            </div>
          </motion.div>
