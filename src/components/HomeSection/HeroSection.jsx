...
const HeroSection = () => {
  ...
  return (
    <div className="relative w-full min-h-screen overflow-hidden flex flex-col md:flex-row items-center justify-center lg:justify-between container-custom pt-20 lg:pt-0 ">
        ...
        <div className="xl:max-w-4xl  lg:max-w-3xl mx-auto lg:mx-0  ">
          {showFirstText && (
            <motion.div
              ...
              className="text-white mt-16 text-5xl xl:text-7xl md:text-4xl lg:text-7xl font-bold mb-6 leading-tight  lg:text-left"
            >
              <motion.p
          ...
          {showSecondText && (
            <motion.div
              ...
              className="text-white mt-16 text-5xl md:text-4xl lg:text-7xl xl:text-7xl font-bold mb-6 leading-tight  lg:text-left"
            >
              <motion.p
                initial={{ opacity: 0, y: 30 }}
                animate={{ opacity: 1, y: 0 }}
      ...
      <motion.div
        className="relative  lg:absolute z-10 w-[600px] h-[550px] sm:w-[450px] sm:h-[450px] md:w-[750px] md:h-[750px] lg:w-[600px] lg:h-[600px] xl:w-[700px] xl:h-[700px] 2xl:w-[900px] 2xl:h-[900px] mx-auto my-8 lg:my-0 right-50 md:right-10 lg:right-16 xl:right-20 2xl:right:0 lg:top-1/2 lg:transform lg:-translate-y-1/2 cursor-pointer order-2 lg:order-none"
